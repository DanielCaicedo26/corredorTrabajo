...
namespace Business
{
    public class PaymentUserBusiness
    {
        ...
        private static PaymentUserDto MapToDto(PaymentUser user) => new PaymentUserDto
        {
            Id = user.Id,
        ...
        private static PaymentUser MapToEntity(PaymentUserDto userDto) => new PaymentUser
        {
            Id = userDto.Id,
